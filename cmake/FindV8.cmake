...
ELSE()
    FIND_LIBRARY(V8_LIBRARY
        ...
        ${V8_ROOT}/out/ia32.release/lib.target/
        ${V8_ROOT}/out/x64.release/lib.target/
        $ENV{V8_ROOT}
        $ENV{V8_ROOT}/lib
        ~/Library/Frameworks
        /Library/Frameworks
    ...
    FIND_LIBRARY(V8_LIBRARY_DEBUG
        ...
        ${V8_ROOT}/lib
        ${V8_ROOT}/build/Debug/lib
        ${V8_ROOT}/out/ia32.debug/lib.target/
        ${V8_ROOT}/out/x64.debug/lib.target/
        $ENV{V8_ROOT}
        $ENV{V8_ROOT}/lib
        ~/Library/Frameworks
        /Library/Frameworks
